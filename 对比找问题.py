...
class HeroPlanc(pygame.sprite.Sprite):
    def __init__(self, screen):
        ...
        #  这个组下self.image = pygame.image.load("feijidazha_images/images/bullet1.png")
        #         self.rect = self.image.get_rect()
        #  self.image  是在组里定义好了的 不能改
...
class EnemyPlane(pygame.sprite.Sprite):
    def __init__(self, screen):
        ...
        self.speed = 4
        self.screen = screen
        self.bullets = pygame.sprite.Group()  #定义了一个精灵类组
        #  联系：
